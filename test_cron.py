"""
Tests for the cron scheduling feature of canvas-manager-v4.
...
Covers:
  ...
  3. The live crontab contains a canvas-manager-v4 entry
...
PACKAGE_DIR = PROJECT_DIR / "canvas_manager_v4"
...
class TestCronSetupCommand(unittest.TestCase):
    ...
    def test_default_time_is_08_00(self):
        from canvas_manager_v4.main import cli
    ...
    def test_output_contains_binary_name(self):
        ...
        result = self.runner.invoke(cli, ["setup-cron"])
        self.assertEqual(result.exit_code, 0, result.output)
        self.assertIn("canvas-manager-v4", result.output)
    ...
    def test_log_path_is_absolute_in_output(self):
        ...
        lines = [l.strip() for l in result.output.splitlines() if "canvas-manager-v4" in l and "remind" in l]
...
class TestFilePathsAreAbsolute(unittest.TestCase):
    ...
    def test_token_file_is_absolute(self):
        from canvas_manager_v4 import notifier
        self.assertTrue(
    ...
    def test_deadlines_cache_is_absolute(self):
        from canvas_manager_v4.main import DEADLINES_CACHE
        self.assertTrue(
    ...
    def test_token_file_resolves_inside_project(self):
        ...
        self.assertTrue(
            ...
            "token_v4.json should live in the project root"
        )
...
class TestLiveCrontab(unittest.TestCase):
    """The system crontab has the expected canvas-manager-v4 entries."""

    def setUp(self):
        self.crontab = _get_crontab()

    def test_daily_8am_entry_exists(self):
        self.assertIn("canvas-manager-v4", self.crontab,
                      "No canvas-manager-v4 entry found in crontab")
...
class TestRemindPreview(unittest.TestCase):
    ...
    def test_preview_empty_cache_warns(self):
        from canvas_manager_v4.main import cli, DEADLINES_CACHE
